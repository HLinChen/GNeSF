...
def config_parser():
    ...
    parser.add_argument('--datadir', type=str,
                        default='/data/hlchen/data/',
                        help='the path to the data directory. Replace this path with yours!')
    ...
    parser.add_argument("--sample_step", type=int, default=1,
                        help='will load 1/N images from data,'
                             'useful for large dense datasets like scannet')
    parser.add_argument("--image_size", nargs='+', type=int, default=[],
                        help='the weights for training datasets, valid when multiple datasets are used.')
    parser.add_argument("--crop", type=int, default=0, help='rank for distributed training')
    parser.add_argument("--pad", type=int, default=0, help='rank for distributed training')
    ...
    parser.add_argument('--preload', action='store_true', help='if preload the entire dataset into the memory')
    ## semantic
    parser.add_argument('--enable_semantic', action='store_true', help='if semantic segmentation')
    parser.add_argument('--enable_one_hot', action='store_true', help='if depth supervision')
    parser.add_argument("--enable_2dsem_seg", action='store_true', help='if 2D semantic segmentation (weighted sum)')
    parser.add_argument('--enable_rgb', action='store_true', help='if color supervision')
    parser.add_argument('--num_cls', type=int, default=41, help='number of semantic class')
    parser.add_argument('--wgt_sem', type=float, default=4e-2, help='weight of semantic loss')
    parser.add_argument('--wgt_sem2d', type=float, default=4e-2, help='weight of 2d semantic segmentation loss')
    parser.add_argument('--wgt_depth', type=float, default=1, help='weight of semantic loss')
    parser.add_argument('--ignore_label', type=int, default=-1, help='ignore label for cross entropy')
...
#     parser.add_argument("--feature_model_cfg", type=str, default="", help='config path of feature model')
    parser.add_argument("--seg2d_model_cfg", type=str, default="", help='config path of feature model')
    parser.add_argument("--seg2d_model_path", type=str, default="", help='pretrain path of feature model')
